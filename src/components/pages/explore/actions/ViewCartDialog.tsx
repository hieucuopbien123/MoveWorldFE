...
const ViewCartDialog = ({ isOpen, onToggle, setCartItems, cartItems }: any) => {
  ...
  const { aptosToDollar, callEveryComponentFetchData, fetchBalance } = useAppContext();
  ...
  const completePurchase = async () => {
    ...
    try {
      ...
      await SaleContract.bulkBuyNFT({
        orders: cartItems.map((item: any) => {
          return {
              ...
              >
                ...
                <CardBody padding={0}>
                  ...
                  <Box
                    ...
                    overflow="auto"
                    maxHeight="calc(100vh - 90px - 120px - 270px)"
                    minHeight="80px"
                  >
                  ...
                  <Box p="20px" display="flex" flexDirection="column" gap="20px">
                    ...
                    >
                      {loading ? <BeatLoader size={8} color="white" /> : "Compelete Purchase"}
                    </Button>
                    <Text opacity={0.8}>
                      By clicking &#34;Complete Purchase&#34;, you agree to the MoveWorld Terms of
                      Service. Each transaction will incure non-refundable gas fees.
                    </Text>
                  </Box>
                </CardBody>
              </Card>
